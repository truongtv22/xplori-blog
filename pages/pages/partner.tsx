...
const Index = () => {
    ...
    return (
        <>
            <Head>
                <title>Our Partner - Xplori</title>
            </Head>
            <div className="mt-[70px]">
                <div className="container py-20">
                    <img alt="" className="rounded-lg" src="https://cdn.shopify.com/s/files/1/0023/8403/5875/files/partner-bg.png?v=1557847653"/>
                    <div className="md:w-1/5 hidden lg:block lg:w-1/4 h-12 z-[-1] w-12 md:h-[11rem] lg:h-[10rem] md:absolute md:left-25 md:top-0 lg:-left-9 lg:-top-[4rem]"
                        style={{
                            backgroundImage: "radial-gradient(#ff7f7f 2px, transparent -3.5px)",
